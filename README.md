...
- **[R3]** Perspective calibrate sai → Chọn lại chính xác 4 góc trong cửa sổ calibration thủ công
...
- Trong cửa sổ chọn 4 góc thủ công, `R` chỉ xóa các góc đã chọn, `S` lưu, và `Q` hủy.
