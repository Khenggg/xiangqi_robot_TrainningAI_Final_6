...
- **Severity:** **HIGH**
- **Evidence:** Khoảng cách ô cờ được khai báo nhiều nơi với các giá trị khác nhau:
  - `config.py`: `CELL_SIZE_X = 40.0`, `CELL_SIZE_Y = 40.0`
  - `robot_VIP.py` (dry-run teaching points R1-R4): Khoảng cách tính ra là $X=44.45\text{ mm}$, $Y=45.08\text{ mm}$
  - `robot-3d-viewer/board.mjs`: Canvas tính `squareHeight = (canvas.height - paddingY * 2) / 9 = 45.5\text{ mm}`
...
- **Recommended Phase:** **Phase P1 (Thiết lập rào chắn an toàn và tách biệt test)**
