...
2. `world_state`: 3D poses and quaternions for all 32 pieces, gripper jaw opening, grasp status, and attachment metadata.

### Example `world_state` Payload:
```json
{
  "type": "world_state",
  ...
  "gripper": {
    "is_closed": true,
    "jaw_opening_m": 0.022,
    "grasp_center_robot_m": [-0.360, 0.080, 0.054],
    "grasp_center_world_m": [0.080, 0.054, 0.360]
  },
  "pieces": {
    "black_cannon_0": {
      ...
      "side": "b",
      "type": "c",
      "pos_robot_m": [-0.360, 0.080, 0.054],
      "pos_world_m": [0.080, 0.054, 0.360],
      "quat_robot": [0.0, 0.0, 0.0, 1.0],
      "quat_world": [-0.5, 0.5, 0.5, 0.5],
      "physical_state": "attached",
      "linear_vel_m_s": [0.0, 0.0, 0.0],
      "angular_vel_rad_s": [0.0, 0.0, 0.0],
      "is_attached": true,
      "tilt_deg": 0.0
    }
  }
...
The physical simulation subsystem is backed by 74 automated unit tests and an acceptance demonstration suite:
